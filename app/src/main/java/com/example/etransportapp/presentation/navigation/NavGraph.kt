...
fun NavGraph(
    ...
    NavHost(
        ...
        composable(NavRoutes.VEHICLE_ADS) { VehicleAdsScreen(modifier, navController,vehicleAdViewModel) }
        composable(NavRoutes.MY_ADS) { MyAdsScreen(modifier, navController,loadAdViewModel, vehicleAdViewModel) }
        composable(NavRoutes.PROFILE) { ProfileScreen(modifier, navController) }
        composable(NavRoutes.CREATE_LOAD_AD) { CreateLoadAdScreen(modifier, navController,loadAdViewModel) }
        composable(NavRoutes.CREATE_VEHICLE_AD) { CreateVehicleAdScreen(modifier, navController,vehicleAdViewModel) }
